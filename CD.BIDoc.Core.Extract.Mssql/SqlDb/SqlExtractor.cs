...
namespace CD.DLS.Extract.Mssql.SqlDb
{
    class SqlExtractor
    {
        ...
        public SqlExtractor(MssqlDbProjectComponent dbProjectComponent, string outputDirPath, string relativePathBase, Manifest manifest)
        {
