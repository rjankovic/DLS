...
namespace CD.DLS.Extract.Mssql.Ssis
{
    class SsisExtractor
    {
        ...
        public SsisExtractor(SsisProjectComponent ssisProjectComponent, string outputDirPath, string relativePathBase, Manifest manifest)
        {
        ...
        //            ///**/
        //            if (creationName.Contains("ExecuteSQLTask"))
        //            {
        //                var sqlTask = (ExecuteSQLTask)task;
