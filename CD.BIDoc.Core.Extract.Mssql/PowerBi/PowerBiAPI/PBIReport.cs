...
{
    [DataContract]
    public class PBIReport : Microsoft.PowerBI.Api.V2.Models.Report, IPBIObject
    {
        /*
        {
        ...
        */
        ...
        public PBIReport()
        { }
        public PBIReport(Microsoft.PowerBI.Api.V2.Models.Report report, IPBIObject pbiObject)
        {
            Id = report.Id;
            Name = report.Name;
