...
namespace CD.DLS.Common.Storage.FileSystem
{
    public class FileLogger : ILogger
    {
        ...
        public FileLogger(string source = null, string filePath = null)
        {
            ...
            {
                File.WriteAllText("D:\\Log\\Receiver1.log", ex.Message + (ex.InnerException == null ? string.Empty : (Environment.NewLine + ex.InnerException.Message)) + Environment.NewLine + ex.StackTrace);
            }
        }
