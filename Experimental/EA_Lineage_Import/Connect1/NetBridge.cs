...
namespace Connect1
{
    public static class NetBridge
    {
        ...
        static NetBridge()
        {
            ...
            configMap.ExeConfigFilename = Path.Combine(asmPath, "App.config");
            Configuration config = ConfigurationManager.OpenMappedExeConfiguration(configMap, ConfigurationUserLevel.None);
            ConnectionStringSettings css;
            css = ConfigurationManager.ConnectionStrings["projectModel"];
            if (css == null)
            {
                css = config.ConnectionStrings.ConnectionStrings["projectModel"];
            }
            if (css != null)
            {
                _configuredConnstring = css.ConnectionString;
                _connstring = css.ConnectionString;
            }
            //_conn = new SqlConnection(css.ConnectionString);
        }

        public static void UseTemporaryConnstring(string connstring)
        {
            _connstring = connstring;
        }

        public static void UseDefaultConnstring()
        {
            _connstring = _configuredConnstring;
        }

        private static string SetParams(SqlCommand cmd, Dictionary<string, object> parameters, bool explicitNames = false)
        {
        ...
        private static string SetOutputParams(SqlCommand cmd, Dictionary<string, SqlDbType> outputParams, bool explicitNames = false)
        {
        ...
        public static object ExecuteScalarFunction(string name, Dictionary<string, object> parameters = null)
        {
            object res;
        ...
        public static void ExecuteProcedure(string name, Dictionary<string, object> parameters = null)
        {
            if (parameters == null)
            {
                parameters = new Dictionary<string, object>();
        ...
        public static Dictionary<string, object> ExecuteProcedureWithOutParams(string name, Dictionary<string, object> inputParameters, Dictionary<string, SqlDbType> outputParameters)
        {
        ...
        public static object ExecuteProcedureScalar(string name, Dictionary<string, object> parameters = null)
        {
            if (parameters == null)
            {
                parameters = new Dictionary<string, object>();
        ...
        public static DataTable ExecuteProcedureTable(string name, Dictionary<string, object> parameters = null)
        {
        ...
        public static DataTable ExecuteTableFunction(string name, Dictionary<string, object> parameters = null)
        {
            DataTable res = new DataTable();
        ...
        /// <returns></returns>
        public static DataTable ExecuteSelectStatement(string sql)
        {
            DataTable res = new DataTable();
        ...
        public static DataTable ExecuteSelectStatement(string sql, Dictionary<string, object> parameters)
        {
            DataTable res = new DataTable();
