...
namespace CD.DLS.Parse.Mssql.Ssis.SsisDfComponentParser
{
    class DerivedColumnComponentParser : SsisDfComponentParserBase, ISsisDfComponentParser
    {
        ...
        {
            var componentElement = new DfDerivedColumnElement(context.ComponentRefPath, context.Component.Name, context.Component.XmlDefinition, context.DfElement);
            ...
            DfOutputElement outputNode = new DfOutputElement(context.UrnBuilder.GetDfOutputUrn(componentElement, derivedColumnOutput.Name), derivedColumnOutput.Name,
                //context.DefinitionSearcher.GetDfComponentOutputDefinition(context.ComponentDefinitionXml, derivedColumnOutput.RefId, out outputDefinitionXml)
                derivedColumnOutput.XmlDefinition
                , componentElement);
