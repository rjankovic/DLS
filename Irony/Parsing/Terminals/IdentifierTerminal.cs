...
namespace Irony.Parsing {
  ...
  public class IdentifierTerminal : CompoundTerminalBase {
    ...
    public IdentifierTerminal(string name, string hash) : base(name)
    {
      AllFirstChars = Strings.AllLatinLetters + hash;
      AllChars = Strings.AllLatinLetters + Strings.DecimalDigits + hash;
    }
