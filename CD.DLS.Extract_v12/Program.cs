        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                if (sqlComponent != null)
                {
                    ...
                    var sqlExtractor = new Extract_v12.Mssql.SqlDb.SqlExtractor_v12(sqlComponent, mssqlDbDirPath, sqlDirName, manifest);
                ...
                else if (ssisComponent != null)
                {
                    ...
                    var extractor = new Extract_v12.Mssql.Ssis.SsisExtractor_v12(ssisComponent, ssisDirPath, ssisDirName, manifest);
                    extractor.Extract();
