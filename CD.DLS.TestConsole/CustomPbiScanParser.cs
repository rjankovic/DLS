...
namespace CD.DLS.TestConsole
{
    ...
    class CustomPbiScanParser
    {
        ...
        private List<TabularModel> ExtractWorkspacesScan(string scanJson)
        {
        ...
        private TabularModel ExtractDatasetModel(JObject jDataset, string workspaceId, string workspaceName, Dictionary<string, TabularDataSource> datasources)
        {
        ...
        private TabularTable ExtractTable(JObject jTable, Dictionary<string, TabularDataSource> datasources)
        {
