...
namespace CD.DLS.Extract_v11.Mssql.SqlDb
{
    public class SqlExtractor_v11
    {
        ...
        public SqlExtractor_v11(MssqlDbProjectComponent dbProjectComponent, string outputDirPath, string relativePathBase, Manifest manifest)
        {
